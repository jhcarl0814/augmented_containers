    ...
    namespace detail
    {
        namespace augmented_sequence_rb3p
        {
            ...
            struct rb3p_iterator_t
            {
                ...
                static rb3p_iterator_t from_element_pointer(pointer ptr) { return {std::pointer_traits<pointer_navigator_t>::pointer_to(*reinterpret_cast<node_t *>(const_cast<std::byte *>(reinterpret_cast<conditional_const_t<is_const, std::byte> *>(std::to_address(ptr))) - offsetof(node_t, element_buffer)))}; }
